...
const mapStateToProps = ({ settingOrg }) => {
  return {
    data: settingOrg.deactivatedDrivers.data,
    page: settingOrg.deactivatedDrivers.page,
    total: settingOrg.deactivatedDrivers.total,
    pageSize: settingOrg.deactivatedDrivers.pageSize
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(DeactivatedDriver);