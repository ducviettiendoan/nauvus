...
export function FuelCards(props) {
  ...
  const formatCardVendor = (cell, row) => {
    return <>
      <div className={classes.textName}>{cell}</div>
    </>
  }

  const formatCode = (cell, row) => {
    return <>
      <div className={classes.textSub}>{cell}</div>
    </>
  }

  const formatBillGroup = (cell, row) => {
    return <>
      <div className={classes.textSub}>{cell}</div>
    </>
  }
              ...
              <Card testimonial>
                <CardBody>
                  <GridContainer>
                    ...
                    <GridItem xs={12} sm={12} md={6}>
                      <ToolboxButton placeholder={"Search fuel cards"} showFilter showTrash/>
                    </GridItem>
                  </GridContainer>
                </CardBody>
                <ToolkitProvider
                  ...
                  columns={[
                    {
                      ...
                      text: "Fuel Card Vendor",
                      formatter: formatCardVendor
                    },
                    {
                      dataField: "code",
                      text: "Fleet Cor or Account Code",
                      formatter: formatCode
                    },
                    {
                      dataField: "billGroup",
                      text: "Bill Group or Customer ID",
                      formatter: formatBillGroup
                    },
                    {
                      dataField: "email",
                      text: "Contact Email",
