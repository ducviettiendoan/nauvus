          ...
          <GridItem xs={12} sm={12} md={12} className={classes.vehicleHeaderContainer}>
            ...
            <GridItem className={classes.sensitivityContainer}>
              <GridItem className={classes.sensitivityContent} xs={12} sm={10} md={10}>
                Our recommended settings improve the relevance of harsh events you see in the Safety Inbox. Move sliders left or right to change the sensitivity for
                harsh event detection. MAX will increase the number of events in your Safety Inbox, and OFF will not upload events of that type.
              </GridItem>
