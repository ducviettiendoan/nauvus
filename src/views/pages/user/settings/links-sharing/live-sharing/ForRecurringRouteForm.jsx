...
export default function ForRecurringRouteForm(props) {
            ...
            <form onSubmit={handleSubmit} noValidate>
              <GridContainer justify="space-between">
                <GridItem xs={12} className={classes.radioLabel + " " + classes.formRow}>
                  Share real-time status of an asset on a recurring route.
                </GridItem>
                ...
                <GridItem className={classes.formRow} xs={12}>
                  <InputLabel className={classes.label}>Route</InputLabel>
                  <Field
                    ...
                    style={{margin: 0}}
                  >
                    {routes.map(e => <MenuItem key={e.id} value={e.id}>{e.label}</MenuItem>)}
                  </Field>
                </GridItem>
